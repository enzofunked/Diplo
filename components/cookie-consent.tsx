...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-3 bg-white border-t border-border shadow-lg animate-in slide-in-from-bottom duration-300">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-3">
          <div className="flex items-start gap-2 flex-1">
            <Cookie className="h-5 w-5 text-teal-600 flex-shrink-0 mt-0.5" />
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <Button size="sm" onClick={acceptCookies} className="flex-1 md:flex-none bg-teal-600 hover:bg-teal-700">
              Accepter
            </Button>
          </div>
        </div>
