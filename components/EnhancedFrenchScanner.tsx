...
export default function EnhancedFrenchScanner({ onScan, isScanning, onCameraClick }: EnhancedFrenchScannerProps) {
            ...
            <div className="flex gap-2">
              ...
              {onCameraClick && (
                <Button
                  variant="outline"
                  disabled={true}
                  className="border-green-200 bg-gray-100 text-gray-400 text-sm px-3 cursor-not-allowed"
